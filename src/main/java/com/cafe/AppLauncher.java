...
public class AppLauncher {
    public static void main(String[] args) {
        ...
        // ChiTietHoaDonService chiTietHoaDonService = new
        // ChiTietHoaDonServiceImpl(chiTietHoaDonDAO);
        ...
        // NguyenLieuService nguyenLieuService = new
        // NguyenLieuServiceImpl(nguyenLieuDAO);
        // NhaCungCapService nhaCungCapService = new
        // NhaCungCapServiceImpl(nhaCungCapDAO);
        ...
        SwingUtilities.invokeLater(() -> {
            // HoaDonManagementPanel hoaDonPanel = new
            // HoaDonManagementPanel(hoaDonController);
            ...
            // PhieuNhapPanel phieuNhapPanel = new PhieuNhapPanel(phieuNhapService,
            // nhanVienService, nhaCungCapService);
